# Si scriva un programma che trovi le soluzioni a
# equazioni di secondo grado nella forma ax2 + bx + c = 0, con
# a, b e c interi. Il programma dovrebbe tener conto dei casi particolari.

# Per il calcolo della radice quadrata si può
# utilizzare la funzione sqrt() della libreria matematica math.
